        ...
        <div class="ibox-content"
            ...
            <div class="row">
                ...
                <div class="col-sm-6 b-r">
                    ...
                    <div>
                        <button class="btn btn-sm btn-primary pull-right m-t-n-xs" @click="replenish()"><b>Reserve</b></button>
                    </div>
                </div>

                <div class="col-sm-6">
                    <p class="text-center"><i class="fa fa-lock big-icon"></i></p>
                </div>
            ...
            replenish() {
                ...
                axios
                    ...
                    .then(() => {
                        ...
                        notify.success('Reserve funds successfully!')
                    })
